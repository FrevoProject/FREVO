...
public class Parameters {
	...
	/**
	 * defines the probability of the mutation</br> 0 ...... representation does
	 * not change</br>1 .. everything changes
	 */	
	...
	public void initialize(Hashtable<String, XMLFieldEntry> properties) {
		...
		XMLFieldEntry neighborhoodmode = properties.get(
				"neighbourhoodmode");
